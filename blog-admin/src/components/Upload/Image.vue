<template>
  <div class="upload-container">
    ...
    <el-button type="primary" @click="handleGenerateImg" style="margin-top: 10px;">
      AI生成图片
    </el-button>
...
import { uploadApi,deleteFileApi,generateImgApi } from '@/api/file'
...
const handleGenerateImg = async () => {
  ...
  const res = await generateImgApi(props.articleTitle)
  if (res.code === 200) {
    const url = res.data
    if (props.multiple) {
      const urls = props.modelValue ? [...(props.modelValue as string[])] : []
