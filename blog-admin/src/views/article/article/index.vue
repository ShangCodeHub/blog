    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="1400px" top="3vh" :close-on-click-modal="false">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="文章封面" prop="cover">
          <UploadImage v-model="form.cover" :limit="1" :source="'article-cover'" :article-title="form.title"  />
        </el-form-item>
...
.avatar-uploader {
  :deep(.el-upload) {
    border: 2px dashed var(--el--lighter);
    border-radius: 8px;
    cursor: pointer;
    position: relative;
    overflow: hidden;
...
.app-container {
  ...
  .dialog-footer {
    text-align: right;
    padding-top: 20px;
    border-top: 1px solid var(--el--lighter);
...
:root[data-theme='dark'] {
  .app-container {
    :deep(.el-dialog) {
      .el-form {
        .el-input__wrapper {
          box-shadow: 0 0 0 1px var(--el-) inset;
        }
      }
    }
  }
