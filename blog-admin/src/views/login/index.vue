    ...
    <div class="split-screen">
      ...
      <div class="brand-section">
        ...
        <div class="brand-content">
          ...
          <p class="brand-description">基于 Vue3 + TypeScript </p>
...
.login-box {
  ...
  .dark & {
    ...
    /* 修改以下行：补全属性名（可能是 `backdrop-filter` 或其他属性） */
    backdrop-filter: blur(20px); // ✅ 示例修正（根据实际需求调整）
    box-shadow:
...
:deep(.el-input__wrapper),
.captcha-img {
  transition:  0.3s, box-shadow 0.3s, opacity 0.3s !important;
}
